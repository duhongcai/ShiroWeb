...
<div class="container af-container">
    <form class="af-form" action="${pageContext.request.contextPath}/index" method="post">
       ...
       <div class="input-group">
           ...
           <image id="verfyCodeImage" src="/shiroWeb/getCaptcha" style="padding: 3px">
           </image>
...
<script type="text/javascript" src="../../shiroWeb/assert/plugins/jquery-1.10.2.min.js"></script>
<script type="text/javascript">
    ...
    $("#changeVerifyCode").click(function(){
        ...
        $("#verfyCodeImage").attr("src","/shiroWeb/getCaptcha?t = "+timestamp)
    })
</script>
</body>
</html>
